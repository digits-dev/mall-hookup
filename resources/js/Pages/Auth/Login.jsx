    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center p-5 justify-center w-screen h-screen font-poppins bg-center">
                ...
                />
                <p className="text-white text-md md:text-xl z-50 font-semibold">
                    MALL HOOKUP
                </p>
                <form
                    onSubmit={handleLogin}
                    className="flex z-50 flex-col m-5 items-center bg-white/20 w-full border border-white/40 rounded-xl shadow-lg p-6 max-w-md"
                >
                    <p className="text-white text-2xl md:text-3xl font-semibold my-4">
                        Login
                    </p>
                    <LoginInput
                        addMainClass="mt-2"
